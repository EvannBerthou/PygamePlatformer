...
def load_animation(file_name, sprite_size, render_size, number_of_sprite = 0, sprite_offset = 0):
    ...
    for y in range(n_y):
        for x in range(n_x):
            ...
            subsurface = spritesheet.subsurface((sprite_size[0] * x, sprite_size[1] * y, *sprite_size)).convert_alpha()
